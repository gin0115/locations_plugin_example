 ...
 */
class UploadedFile implements \PcLocations_001\Psr\Http\Message\UploadedFileInterface
{
    /** @var array */
    ...
    public function __construct($streamOrFile, $size, $errorStatus, $clientFilename = null, $clientMediaType = null)
    {
        ...
        if (\UPLOAD_ERR_OK === $this->error) {
            ...
            if (\is_string($streamOrFile)) {
                ...
                $this->stream = \PcLocations_001\Nyholm\Psr7\Stream::create($streamOrFile);
            } elseif ($streamOrFile instanceof \PcLocations_001\Psr\Http\Message\StreamInterface) {
    ...
    public function getStream() : \PcLocations_001\Psr\Http\Message\StreamInterface
    {
        $this->validateActive();
        if ($this->stream instanceof \PcLocations_001\Psr\Http\Message\StreamInterface) {
            return $this->stream;
        }
    ...
    public function moveTo($targetPath) : void
    {
        ...
        if (null !== $this->file) {
            ...
            $dest = \PcLocations_001\Nyholm\Psr7\Stream::create(\fopen($targetPath, 'w'));
            while (!$stream->eof()) {
