...
trait MessageTrait
{
    ...
    public function getBody() : \PcLocations_001\Psr\Http\Message\StreamInterface
    {
        if (null === $this->stream) {
            $this->stream = \PcLocations_001\Nyholm\Psr7\Stream::create('');
        }
        return $this->stream;
    }
    public function withBody(\PcLocations_001\Psr\Http\Message\StreamInterface $body) : self
    {
        if ($body === $this->stream) {
            return $this;
        }
