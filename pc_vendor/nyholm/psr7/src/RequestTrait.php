...
trait RequestTrait
{
    ...
    public function getUri() : \PcLocations_001\Psr\Http\Message\UriInterface
    {
        return $this->uri;
    }
    public function withUri(\PcLocations_001\Psr\Http\Message\UriInterface $uri, $preserveHost = \false) : self
    {
        if ($uri === $this->uri) {
            return $this;
        }
