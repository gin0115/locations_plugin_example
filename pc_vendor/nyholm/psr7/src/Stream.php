...
use PcLocations_001\Symfony\Component\Debug\ErrorHandler as SymfonyLegacyErrorHandler;
use PcLocations_001\Symfony\Component\ErrorHandler\ErrorHandler as SymfonyErrorHandler;
/**
 ...
 */
class Stream implements \PcLocations_001\Psr\Http\Message\StreamInterface
{
     ...
     */
    public static function create($body = '') : \PcLocations_001\Psr\Http\Message\StreamInterface
    {
        if ($body instanceof \PcLocations_001\Psr\Http\Message\StreamInterface) {
            return $body;
        }
        if (\is_string($body)) {
    ...
    public function __toString()
    {
        try {
            ...
            if ($e instanceof \Error || $errorHandler instanceof \PcLocations_001\Symfony\Component\ErrorHandler\ErrorHandler || $errorHandler instanceof \PcLocations_001\Symfony\Component\Debug\ErrorHandler) {
