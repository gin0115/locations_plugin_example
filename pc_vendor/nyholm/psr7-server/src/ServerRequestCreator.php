...
namespace PcLocations_001\Nyholm\Psr7Server;
 ...
 */
final class ServerRequestCreator implements \PcLocations_001\Nyholm\Psr7Server\ServerRequestCreatorInterface
{
    private $serverRequestFactory;
    private $uriFactory;
    private $uploadedFileFactory;
    private $streamFactory;
    public function __construct(\PcLocations_001\Psr\Http\Message\ServerRequestFactoryInterface $serverRequestFactory, \PcLocations_001\Psr\Http\Message\UriFactoryInterface $uriFactory, \PcLocations_001\Psr\Http\Message\UploadedFileFactoryInterface $uploadedFileFactory, \PcLocations_001\Psr\Http\Message\StreamFactoryInterface $streamFactory)
    {
     ...
     * {@inheritdoc}
     */
    public function fromGlobals() : \PcLocations_001\Psr\Http\Message\ServerRequestInterface
    {
        $server = $_SERVER;
     ...
     * {@inheritdoc}
     */
    public function fromArrays(array $server, array $headers = [], array $cookie = [], array $get = [], ?array $post = null, array $files = [], $body = null) : \PcLocations_001\Psr\Http\Message\ServerRequestInterface
    {
        ...
        } elseif (!$body instanceof \PcLocations_001\Psr\Http\Message\StreamInterface) {
    ...
    private function getUriFromEnvWithHTTP(array $environment) : \PcLocations_001\Psr\Http\Message\UriInterface
    {
    ...
    private function normalizeFiles(array $files) : array
    {
        ...
        foreach ($files as $key => $value) {
            if ($value instanceof \PcLocations_001\Psr\Http\Message\UploadedFileInterface) {
     ...
     */
    private function createUriFromArray(array $server) : \PcLocations_001\Psr\Http\Message\UriInterface
    {
